<template>
    <div>
        <h4>
            This is <b>Not The Official</b> tracker of Corona Virus in Morocco.
        </h4>
        <h5>
            For More Information, check:
        </h5>
        <div class="row mt-5">
            <div class="col-sm-4  bg-light shadow rounded p-2 card">
                <a href="https://who.int" target="_blank" class="text-secondary">WHO (World Health Organization)</a>
            </div>
            <div class="offset-sm-1 col-sm-3  bg-light shadow rounded p-2 card">
